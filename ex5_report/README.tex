...
For running \filename{part2.m} script, adjust parameters first. TODO
...
\begin{itemize}
	...
	\begin{subfigure}[b]{0.225\textwidth}
		\noindent\makebox[\textwidth]{
		  \includegraphics[width=\textwidth]{task2-fig-2.png}
		}
	\caption{Shifting the screw axis}
	\end{subfigure}
	\end{figure}
	
	Dual quaternion can be intuitively represented by a screw which of unit vector $\vec{s}_0$ as a screw axis, $\theta_0$ the angle of rotation and $\theta_\epsilon$ is the amount of translation. For the 2D case of Figure 1.1, if the axis of screw is shifted to point $\vec{r}$, as shown in Figure 1.1 (b) such transformation can be represented as a screw axis i.e. dual quaternion. In this case, $\vec{s}_\epsilon = \vec{r} \times \vec{s}_0$   
	
	\textbf{TODO additional explanation + r draw} 
...
\begin{figure}[b]
	\caption{Denoised image after filtering multiple time\label{fig:simple}}
	\centering
	\begin{subfigure}[b]{0.45\textwidth}
		\noindent\makebox[\textwidth]{
